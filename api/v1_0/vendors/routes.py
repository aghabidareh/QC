...
@vendor_router.get("/{vendor_id:int}", response_model=SingleVendor,
...
@vendor_router.get('/active-qc-vendor-list', response_model=ActiveVendors,
...
@vendor_router.get('/active-qc-vendor-single', response_model=ActiveVendors,
